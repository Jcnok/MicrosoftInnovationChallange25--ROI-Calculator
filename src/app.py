...
if menu == "Página Inicial":
    ...
    st.write("LUIZ FELIPE BOM - [LinkedIn](https://www.linkedin.com/in/luiz-felipe-bom/) - [GitHub](https://github.com/luizfbom)")
    st.write("JOÃO BRENO - [LinkedIn](https:/www.linkedin.com/in/joão-breno4/) - [GitHub](https://github.com/joaobreno4)")
